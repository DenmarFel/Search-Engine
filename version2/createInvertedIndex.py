        ...
        while token_postings:
            ...
            if token not in inverted_index_pickle:
                ...
                for i in range(len(formatted_postings)):
                    open_file.write(formatted_postings[i] + ' | ')
            else:
                for i in range(len(formatted_postings)):
                    open_file.write(formatted_postings[i] + ' | ')
...
mergePartialIndexes("version2/partial_indexes/partial_indexes0518", "version2/inverted_indexes/inverted_index0518.txt", "version2/inverted_indexes/inverted_index0518.pickle")